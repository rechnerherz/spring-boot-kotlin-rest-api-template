...
import at.rechnerherz.example.config.TRANSACTION_ADVICE_ORDER
...
@Component
@Profile(DEVELOPMENT)
@Order(TRANSACTION_ADVICE_ORDER - 2)
class ProfilingSummaryAspect(
    ...
    @Around("@annotation(at.rechnerherz.example.config.aop.ProfilingSummary) && @annotation(profilingSummary)")
